...
buildscript {
    ...
    dependencies {
        ...
        classpath("com.github.Luna712:gradle:content-ratings-SNAPSHOT")
...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/Luna712/cloudstream-extensions-hexated")
